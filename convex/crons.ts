...
crons.interval('refresh-text-insights', { minutes: 10 }, internal.analytics.refreshTextSummariesBatch, {});
crons.cron(
  'daily-analytics-consistency-rebuild',
  '0 0 * * *',
  internal.analytics.rebuildRecentWindowForAllSurveys,
  {},
);
